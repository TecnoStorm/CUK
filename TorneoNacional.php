...
<head>
    ...
    <title>Confederacion Uruguaya de Karate</title>
</head>
<body>
    <!DOCTYPE html>
    <html lang="en">
    ...
    <body>
        ...
        <li><a href="Arbitraje.html">Arbitraje</a></li>
            ...
            <div id="encabezado">
                ...
                <div id="botones">
                    ...
                    <div class="puntos-encabezado">
                       <a  href="Noticias.html"><button onmouseover="menuNoticia()" onmouseout="ocultarMenuNoticia()">Noticias</button></a> 
                        <ul id="noticias-opciones" onmouseover="menuNoticia()" onmouseout="ocultarMenuNoticia()">
                            <a href="Eventos.html">  <li id="txtEventos"> Eventos </li> </a>
                        </ul>
                    </div>
                    <div class="puntos-encabezado">
                    ...
                    <div class="puntos-encabezado">
                   <a href="Galeria.php"><button>Galeria de imagenes</button></a> 
                    </div>
                    <div class="puntos-encabezado">
        ...
        <h1>2do Torneo Nacional de Fullcontact Karate</h1>
        <?php
    echo "<div class='contenedor'>";
    $rutaImagenes="imagenes/segundoTorneo-imagenes";
    $imagenes=glob($rutaImagenes . "/*.*");
    foreach($imagenes  as $clave => $imagen){
        echo "<style> #imagen".$clave."{background-image: url(".$imagenes[$clave].");}</style>";
        echo "<div class='imagen' id='imagen".$clave."'>";
        echo "</div>";
    }
    echo "</div>";
?>
